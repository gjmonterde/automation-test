...
export default function suite() {
  it("Fj_TestScheme_63-2_0004_step_08: The aggregate value of the inquiry result (the aggregation method is described in parentheses) is set as follows: クレジットカード有無 = (TRUE if any are TRUE)", async () => {
