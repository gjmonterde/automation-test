...
export default function suite() {
  it("Fj_TestScheme_63-2_0006_step_13: The items in 合算返済比率 Combined Repayment Ratio section are calculated from the 借入明細情報一覧 Loan details Information List", async () => {
