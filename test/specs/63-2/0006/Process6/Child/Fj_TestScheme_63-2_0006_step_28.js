...
const parent = require("../Parent/Fj_TestScheme_63-2_0006-6");

export default function suite() {
  it("Fj_TestScheme_63-2_0006_step_28: 適用利率 applicable interest rate must be set as: 利率(銀行審査) - 優遇利率", async () => {
