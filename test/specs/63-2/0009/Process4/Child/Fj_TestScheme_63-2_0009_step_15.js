...
export default async function suite() {
  it("Fj_TestScheme_63-2_0009_step_15: お知らせ内容 The details of the notice can be viewed on the お知らせ詳細画面 notice detail screen", async () => {
    ...
    // Get the WNT record
    await $(`//a[@title='${test_data.testData.wnt2_name}']`).click();
    await browser.pause(10000);
