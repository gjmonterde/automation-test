...
const parent = require("../Parent/Fj_TestScheme_63-2_0011-20");
const util = require("../../../../../pageobjects/utility");

export default async function suite() {
  it("Fj_TestScheme_63-2_0011_step_95: お知らせ内容 details of the notice can be viewed on the お知らせ詳細画面 notice detail screen", async () => {
    ...
    // Get the WNT record
    await $(`//a[@title='${test_data.testData.wnt6_name}']`).click();
    await browser.pause(10000);
