...
export default async function suite() {
  it("Fj_TestScheme_63-2_0011_step_41: The お知らせ内容 details of the notice can be viewed on the お知らせ詳細画面 notice detail screen", async () => {
    ...
    // Get the WNT record
    await $(`//a[@title='${test_data.testData.wnt5_name}']`).click();
    await browser.pause(10000);
