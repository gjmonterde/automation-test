...
export default function suite() {
  it("Fj_TestScheme_50_0006_step_13: The items in the 合算返済比率 Combined Repayment Ratio section are calculated from借入明細情報一覧 List of loan detail information", async () => {
