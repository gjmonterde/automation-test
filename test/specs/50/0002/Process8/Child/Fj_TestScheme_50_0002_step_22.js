...
const parent = require("../Parent/Fj_TestScheme_50_0002-8");
const util = require("../../../../../pageobjects/utility");

export default function suite() {
  it("Fj_TestScheme_50_0002_step_22: Value for 徴求書類ステータス field should be 銀行確認済 upon clicking 確認 button", async () => {
    ...
    const rdc_highlights2 = await $(
      ".//div[@class='highlights slds-clearfix slds-page-header slds-page-header_record-home fixed-position']"
    );
    const rdc_headerBar2 = await $(".//header[@id='oneHeader']");
    const rdc_tabheader2 = await $(
      ".//div[@class='slds-no-print oneAppNavContainer']"
    );
    ...
    await browser.saveFullPageScreen(
      user_info.userInformation.screenshot +
        ...
        "-6",
      {
        hideAfterFirstScroll: [rdc_headerBar2, rdc_tabheader2, rdc_highlights2],
      }
    );
  });
}
