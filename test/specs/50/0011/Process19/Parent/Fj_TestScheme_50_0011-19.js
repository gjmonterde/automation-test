...
import Fj_TestScheme_50_0011_step_93 from "../Child/Fj_TestScheme_50_0011_step_93.js";

export default async function suite() {
  describe("Fj_TestScheme_50_0011-19: Complete contract agreement (契約同意完了)", () => {
    // Execute Login to Salesforce
    Login_to_Salesforce();

    // Execute Fj_TestScheme_50_0011_step_93
    Fj_TestScheme_50_0011_step_93();
  });
}
  ...
  it("Login to Salesforce", async () => {
    ...
    await conn
      ...
      .where({
        ...
        "RecordType.Name": test_data.testData.contract_agreement_record_type,
      })
      .execute(function (err, records) {
        if (err) {
          return console.error(err);
