...
export default function suite() {
  it("Fj_TestScheme_50_0011_step_94: An email with the content set in メール通知(契約同意承認待ち) email notification (waiting for agreement approval) is sent", async () => {
    ...
    // The mail set in メール通知(条件確認) mail notification (waiting for agreement approval) is sent
    // Screenshot - E-mail
