...
export default function suite() {
  it("Fj_TestScheme_50_0011_step_41: At My Page Home, click the link for お知らせ(契約同意)notification (agreement)", async () => {
