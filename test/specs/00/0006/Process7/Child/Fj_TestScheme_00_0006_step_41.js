...
export default function suite() {
  it("Fj_TestScheme_00_0006_step_41: 申込.利率 Application.interest rate must have the following values: 審査決裁.適用利率", async () => {
    ...
    await $("//records-record-layout-section[3]").$(function () {
      this.scrollIntoView({
        behavior: "smooth",
        block: "center",
        inline: "center",
    ...
    await $("//span[contains(., '" + test_data.testData.pro_base_rate + "')]").$(
      function () {
        this.scrollIntoView({
          behavior: "smooth",
          block: "center",
