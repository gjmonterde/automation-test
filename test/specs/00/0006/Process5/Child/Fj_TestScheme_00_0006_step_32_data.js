...
const parent = require("../Parent/Fj_TestScheme_00_0006-5");
const util = require("../../../../../pageobjects/utility.js");

export default function suite() {
  it("Fj_TestScheme_00_0006_step_32_data: Update 1st_モデルPD（上乗せ後PD）and 1st_上乗せPD fields", async () => {
    ...
    // Take screenshot for 00_0006_32-5_data -- Before
    // ★ 新環境適用' New Env Implementation
    await browser.saveFullPageScreen(
      user_info.userInformation.screenshot +
        test_data.testData.spec00 +
...
// ★ 新環境適用' New Env Implementation
export async function DevConsole_1() {
  // Go to Salesforce Developer Console
  await util.Developer_Console(
    test_data.testData.query_0006_32_1 + "'" + test_data.testData.exs_name + "'"
  );
}

// ★ 新環境適用' New Env Implementation
export async function DevConsole_2() {
  // Go to Salesforce Developer Console
  await util.Developer_Console(
    test_data.testData.query_0006_32_2 + "'" + test_data.testData.exs_name + "'"
  );
}
