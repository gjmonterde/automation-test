...
export default function suite() {
  it("Fj_TestScheme_60_0006_step_32: A value of about 0.0001 ~ 3 is arbitrarily manually set in 1st_モデルPD（上乗せ後PD）[fj_1st_ModePD__c] , and the following item values are automatically displayed. ", async () => {
