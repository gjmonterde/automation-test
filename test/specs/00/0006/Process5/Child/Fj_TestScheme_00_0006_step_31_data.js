...
export default function suite() {
  it("Fj_TestScheme_00_0006_step_31_data: Update 1st_モデルPD（上乗せ後PD）and 1st_上乗せPD fields", async () => {
...
// ★ 新環境適用' New Env Implementation
async function DevConsole_1() {
  // Go to Salesforce Developer Console
  await util.Developer_Console(
    test_data.testData.query_0006_31_1 + "'" + test_data.testData.exs_name + "'"
  );
}

// ★ 新環境適用' New Env Implementation
async function DevConsole_2() {
  // Go to Salesforce Developer Console
  await util.Developer_Console(
    test_data.testData.query_0006_31_2 + "'" + test_data.testData.exs_name + "'"
  );
}
