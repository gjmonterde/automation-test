...
export default function suite() {
  it("Fj_TestScheme_00_0011_step_93: The email set in the メール通知email notification (contract formation) is sent", async () => {
    ...
    // Login
    await util.Login_to_MyPage(email, pwd); // ★ 新環境適用' New Env Implementation
