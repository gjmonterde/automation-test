...
export default async function suite() {
  it("Fj_TestScheme_00_0011_step_01: A最終確認(条件確認) final confirmation (condition confirmation) shall be made", async () => {
    ...
    // Go to AGR (1) record
    await parent.Go_to_AGR1(); // ★ 新環境適用' New Env Implementation
    ...
    // Go to AGR (2) record
    await parent.Go_to_AGR2(); // ★ 新環境適用' New Env Implementation
