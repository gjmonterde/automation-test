...
import Fj_TestScheme_00_0011_step_33 from "../Child/Fj_TestScheme_00_0011_step_33";
import Fj_TestScheme_00_0011_step_34 from "../Child/Fj_TestScheme_00_0011_step_34";
import Fj_TestScheme_00_0011_step_35 from "../Child/Fj_TestScheme_00_0011_step_35";
import Fj_TestScheme_00_0011_step_36 from "../Child/Fj_TestScheme_00_0011_step_36";
import Fj_TestScheme_00_0011_step_45 from "../Child/Fj_TestScheme_00_0011_step_45";
import Fj_TestScheme_00_0011_step_46 from "../Child/Fj_TestScheme_00_0011_step_46";

export default async function suite() {
  describe("Fj_TestScheme_00_0011-7: Complete condition check (条件確認完了)", () => {
    // Login to Salesforce
    // NOTE: ALWAYS execute before steps
    Login_to_Salesforce();

    // Execute Fj_TestScheme_00_0011_step_33
    Fj_TestScheme_00_0011_step_33();

    // Execute Fj_TestScheme_00_0011_step_34
    Fj_TestScheme_00_0011_step_34();

    // Execute Fj_TestScheme_00_0011_step_35
    Fj_TestScheme_00_0011_step_35();

    // Execute Fj_TestScheme_00_0011_step_36
    Fj_TestScheme_00_0011_step_36();

    // Execute Fj_TestScheme_00_0011_step_45
    Fj_TestScheme_00_0011_step_45();

    // Execute Fj_TestScheme_00_0011_step_46
    Fj_TestScheme_00_0011_step_46();
  });
}
  ...
  it("Login to Salesforce", async () => {
    ...
    await conn
      ...
      .where({
        ...
        "RecordType.Name": test_data.testData.condition_check_rectype, // ★ 新環境適用' New Env Implementation
      })
      .execute(function (err, records) {
        if (err) {
          return console.error(err);
