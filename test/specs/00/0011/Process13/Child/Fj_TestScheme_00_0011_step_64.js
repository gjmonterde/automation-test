...
export default async function suite() {
  it(
    "Fj_TestScheme_00_0011_step_64: The 毎月の返済額 monthly payments, 増額返済額incremental payments, " +
      "返済日due date, 第１回返済日first payment date, and 最終期限 final due date must be BLANK",
    async () => {
