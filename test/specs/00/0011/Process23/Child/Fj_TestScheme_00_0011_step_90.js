...
const parent = require("../Parent/Fj_TestScheme_00_0011-23");
const util = require("../../../../../pageobjects/utility.js"); // ★ 新環境適用' New Env Implementation

export default function suite() {
  it("Fj_TestScheme_00_0011_step_90: The sub screen is displayed and the recondition check operation can be performed", async () => {
