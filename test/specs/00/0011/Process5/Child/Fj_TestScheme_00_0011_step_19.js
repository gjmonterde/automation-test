...
export default async function suite() {
  it(
    "Fj_TestScheme_00_0011_step_19: The upper limit of the slider of 「お借入れ金額をお決めください」" +
      "スライダー Please determine the amount of loan must match the value of 申込.融資額(調整上限) Application amount (adjustment limit)",
    async () => {
