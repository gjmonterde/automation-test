...
export default async function suite() {
  it("Fj_TestScheme_00_0011_step_44: The 返済シミュレーション画面repayment simulation screen is deactivated", async () => {
    ...
    if (
      test_data.testData.app_duration_value_44 === "" ||
      test_data.testData.app_duration_value_44 >= inp2
    ) {
      test_data.testData.app_duration_value_44 = Math.floor(inp2 / 2);
    }
    await input2.setValue(test_data.testData.app_duration_value_44);

    // Input date
    await $(".//input[@name='page:pb1:form1:datePicker']").setValue(
      test_data.testData.app_preferred_loan_date_value_44
    );
