...
const parent = require("../Parent/Fj_TestScheme_00_0011-9");
const util = require("../../../../../pageobjects/utility.js"); // ★ 新環境適用' New Env Implementation

export default function suite() {
  it("Fj_TestScheme_00_0011_step_47: The 申込.処理  processing status is changed to 「条件確認登録待ち」Waiting for condition confirmation registration", async () => {
