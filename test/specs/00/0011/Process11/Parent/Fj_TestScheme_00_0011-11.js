...
import Fj_TestScheme_00_0011_step_56 from "../Child/Fj_TestScheme_00_0011_step_56";

export default async function suite() {
  describe("Fj_TestScheme_00_0011-11: Complete condition check (条件確認完了)", () => {
    // Login to Salesforce
    // NOTE: ALWAYS execute before steps
    Login_to_Salesforce();

    // Execute Fj_TestScheme_00_0011_step_56
    Fj_TestScheme_00_0011_step_56();
  });
}
