...
const parent = require("../Parent/Fj_TestScheme_00_0009-4"); // ★ 新環境適用' New Env Implementation
const util = require("../../../../../pageobjects/utility.js"); // ★ 新環境適用' New Env Implementation

export default function suite() {
  it("Fj_TestScheme_00_0009_step_26: The 申込ステータス application status displayed on My Page must be「キャンセル」", async () => {
