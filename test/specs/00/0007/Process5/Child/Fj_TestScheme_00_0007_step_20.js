...
const parent = require("../Parent/Fj_TestScheme_00_0007-5"); // ★ 新環境適用' New Env Implementation

export default function suite() {
  it("Fj_TestScheme_00_0007_step_20: The name of the 保証会社名 guarantor company in the application is「保証会社③」", async () => {
