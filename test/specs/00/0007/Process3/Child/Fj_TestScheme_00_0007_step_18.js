...
export default async function suite() {
  it("Fj_TestScheme_00_0007_step_18: The 処理ステータス processing status is「保証審査承認待ち」'Pending Warranty Review Approval'.", async () => {
    ...
    await $(
      "//span[@title='" + test_data.testData.gud_reject_confirm + "']"
    ).click();
    await browser.pause(5000);
