...
export default function suite() {
  it("Fj_TestScheme_00_0005_step_11: The JICC結果(債権情報)レコード JICC Results (Bond Information) record can be found in the 関連リスト relevant list", async () => {
    ...
    // To view the JICC結果(債権情報) related list
    // Screenshot
    // ★ 新環境適用' New Env Implementation
