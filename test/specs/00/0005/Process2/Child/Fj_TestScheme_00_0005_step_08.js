...
export default function suite() {
  it("Fj_TestScheme_00_0005_step_08: The JICC照会明細(他機関)レコード JICC inquiry detail (other organization) record can be confirmed in the 関連リスト related list of the 借入明細情報一覧", async () => {
