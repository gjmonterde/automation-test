...
export default function suite() {
  it("Fj_TestScheme_00_0005_step_09: The JICC照会明細(他機関)レコード JICC inquiry detail (other organization) record is 0 in the 関連リスト related list of the 借入明細情報一覧", async () => {
