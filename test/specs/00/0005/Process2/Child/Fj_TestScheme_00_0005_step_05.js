...
export default function suite() {
  it("Fj_TestScheme_00_0005_step_05: The JICC照会明細レコード JICC inquiry detail record can be confirmed in the 関連リスト related list of the 外信照会 foreign inquiry", async () => {
