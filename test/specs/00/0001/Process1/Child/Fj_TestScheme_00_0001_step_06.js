...
export default async function suite() {
  it(
    "Fj_TestScheme_00_0001_step_06: The application form will be displayed and the product name will be displayed and" +
      "契約規定・同意条項Contract provisions and consent clauses corresponding to the product are indicated",
    async () => {
      // ★ 新環境適用' New Env Implementation
      const stepNum = "6";

      // Verify URL
      await expect(browser).toHaveUrl(test_data.testData.httpurl02);
      ...
      await browser.switchWindow(test_data.testData.pdf06);
      await browser.refresh();
      await browser.pause(10000);
      ...
      await browser.switchWindow(test_data.testData.pdf07);
      await browser.refresh();
      await browser.pause(10000);
      ...
      await browser.switchWindow(test_data.testData.httpurl02);
    }
  );
}
