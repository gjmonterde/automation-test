...
export default async function suite() {
  it("Fj_TestScheme_00_0001_step_08/09/10/12/15/17/18/19: Application record creation", async () => {
    ...
    //**CONFIRMATION SCREEN Application Record*/
    // Click 次へ button
    ...
    //**COMPLETION SCREEN Application Record*/
    // Remove header
    await parent.Remove_Header();
