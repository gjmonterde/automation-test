...
export default function suite() {
  it("Fj_TestScheme_00_0003_step_19_data: 同一人照会ステータス　Same person inquiry status is「自動OK」'Auto OK'. (Data Linkage)", async () => {
    ...
    let screenshotNum = 0; // ★ 新環境適用' New Env Implementation
    ...
    for (var cdd = 0; cdd < test_data.testData.cdd_array.length; cdd++) {
      ...
      screenshotNum = screenshotNum + 1; // ★ 新環境適用' New Env Implementation
