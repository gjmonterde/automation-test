...
export default async function suite() {
  it(
    "Fj_TestScheme_00_0004_step_25: The inquiry result using 顧客番号 client number is " +
      "registered on 顧客AMLチェック結果情報セクションclient AML ceck result information section",
    async () => {
