...
export default function suite() {
  it("Fj_TestScheme_00_0012_step_25: 2 実行依頼データ submissions of「13_普通預金_貸越契約」record type 13_ordinary deposit_overdraft contract have been created", async () => {
    ...
    // Get 13_普通預金_貸越契約 records
    await parent.Get_ER_Array_Record(test_data.testData.er_13_rectype);
    ...
    // Get LCD records
    await parent.Get_LCD_Record_collect(test_data.testData.lcd_subject_code_2);
