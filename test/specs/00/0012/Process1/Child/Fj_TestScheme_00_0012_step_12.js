...
export default function suite() {
  it(
    "Fj_TestScheme_00_0012_step_12: One 実行依頼データ submission data item of record type「2_融資基本_開設」" +
      '"2_Financing Basic_Established" has been created',
    async () => {
      ...
      // Get ER 2
      await parent.Get_ER_Record(test_data.testData.er_21_rectype);
