...
export default async function suite() {
  it("Fj_TestScheme_00_0012_step_13: the 実行依頼データ execution request data for レコードタイプ「21_カードローン口座閉鎖」record type 21_Card Loan Account Closure has not been created", async () => {
