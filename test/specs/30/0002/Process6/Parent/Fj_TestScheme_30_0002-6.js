...
import Fj_TestScheme_30_0002_step_19 from "../Child/Fj_TestScheme_30_0002_step_19";

export default async function suite() {
  describe("Fj_TestScheme_30_0002-6: Re-upload (再アップロード)", async () => {
    // Query Salesforce records
    Query_Salesforce_Records();

    // Execute Fj_TestScheme_30_0002_step_19
    Fj_TestScheme_30_0002_step_19();
  });
}
