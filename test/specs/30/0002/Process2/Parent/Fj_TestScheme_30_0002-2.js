...
import Fj_TestScheme_30_0002_step_12 from "../Child/Fj_TestScheme_30_0002_step_12";

export default async function suite() {
  describe("Fj_TestScheme_30_0002-2: my page upload (マイページアップロード)", async () => {
    // Query Salesforce records
    Query_Salesforce_Records();

    // Execute Fj_TestScheme_30_0002_step_12
    Fj_TestScheme_30_0002_step_12();
  });
}
