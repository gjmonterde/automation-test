...
import Fj_TestScheme_30_0004_step_06 from "../Child/Fj_TestScheme_30_0004_step_06";
import Fj_TestScheme_30_0004_step_07_data from "../Child/Fj_TestScheme_30_0004_step_07_data";
import Fj_TestScheme_30_0004_step_07 from "../Child/Fj_TestScheme_30_0004_step_07";
import Fj_TestScheme_30_0004_step_11 from "../Child/Fj_TestScheme_30_0004_step_11";
...
export default async function suite() {
  describe("Fj_TestScheme_20_0004-2: Credit card information check (クレジットカード情報確認)", () => {
    ...
    // Execute Fj_TestScheme_30_0004_step_06
    Fj_TestScheme_30_0004_step_06();

    /* if external linkage is not available, execute Fj_TestScheme_30_0004_step_07_data 
    to create/update data. if else, comment out this line. */
    Fj_TestScheme_30_0004_step_07_data();

    // Execute Fj_TestScheme_30_0004_step_07
    Fj_TestScheme_30_0004_step_07();

    // Execute Fj_TestScheme_30_0004_step_11
    Fj_TestScheme_30_0004_step_11();
  });
}
  ...
  it("Query Salesforce Records", async () => {
    ...
    await conn
      ...
      .where({
        ...
        "RecordType.Name": test_data.testData.ini2_rectype, // ★ 新環境適用' New Env Implementation
      })
      .execute(function (err, records) {
        if (err) {
          return console.error(err);
