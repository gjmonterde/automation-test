...
export default async function suite() {
  it("Fj_TestScheme_30_0004_step_35: 所管部確認結果 The results of the department's confirmation and 定型コメントthe fixed comments can be updated.", async () => {
    ...
    // Save changes
    const save = await $(".//button[@name='SaveEdit']");
