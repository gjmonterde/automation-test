...
export default function suite() {
  it("Fj_TestScheme_30_0012_step_24: The 処理  processing status of the 実行結果データ execution result data must be 「自動実行連携失敗」Automatic execution linkage failed", async () => {
