...
const parent = require("../Parent/Fj_TestScheme_30_0011-12.10");

export default function suite() {
  it("Fj_TestScheme_30_0011_step_67: When the 既読にする “Mark as Read ” button is pressed, it is updated to the read state", async () => {
