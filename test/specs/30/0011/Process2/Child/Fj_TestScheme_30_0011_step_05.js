...
const parent = require("../Parent/Fj_TestScheme_30_0011-2");

export default function suite() {
  it("Fj_TestScheme_30_0011_step_05: お知らせ内容 details of the notice can be viewed on the お知らせ詳細画面 notice detail screen", async () => {
