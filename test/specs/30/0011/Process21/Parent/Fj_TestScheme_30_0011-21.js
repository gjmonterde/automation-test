...
import Fj_TestScheme_30_0011_step_110 from "../Child/Fj_TestScheme_30_0011_step_110.js";

export default async function suite() {
  describe("Fj_TestScheme_30_0011-21: Final Approval (最終承認)", () => {
    // Execute login to salesforce
    // NOTE: ALWAYS execute before steps
    Login_to_Salesforce();

    // Execute Fj_TestScheme_30_0011_step_110
    Fj_TestScheme_30_0011_step_110();
  });
}
  ...
  it("Login to Salesforce", async () => {
    ...
    await conn
      ...
      .where({
        ...
        "RecordType.Name": test_data.testData.agreement_text, // ★ 新環境適用' New Env Implementation
      })
      .execute(function (err, records) {
        if (err) {
          return console.error(err);
