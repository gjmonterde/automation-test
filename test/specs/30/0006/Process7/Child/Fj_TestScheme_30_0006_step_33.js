...
export default function suite() {
  it("Fj_TestScheme_30_0006_step_33: 審査決済 Examination Approval Status is changed to「承認済OK」", async () => {
    ...
    const approve_btn_btn = await footer_modal.$(
      ".//button[contains(text(), '" + test_data.testData.approve_btn + "')]"
    );
    await approve_btn_btn.waitForClickable({ timeout: 20000 });
    await approve_btn_btn.click();
