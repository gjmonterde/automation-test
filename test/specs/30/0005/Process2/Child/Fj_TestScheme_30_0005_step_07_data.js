...
export default function suite() {
  it("Fj_TestScheme_30_0005_step_07_data: KSC照会明細 Data Linkage", async () => {
    // Login as Admin
...
async function KID_Record_Creation() {
  ...
  const save_edit_btn_kid = await $(
    ".//button[@name='" + test_data.testData.save_edit_btn + "']"
  );
  await save_edit_btn_kid.waitForClickable({ timeout: 10000 });
  await save_edit_btn_kid.click();
  await browser.pause(5000);
