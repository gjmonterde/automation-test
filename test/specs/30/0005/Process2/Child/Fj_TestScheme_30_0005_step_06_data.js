...
export default function suite() {
  it("Fj_TestScheme_30_0005_step_06_data: JICC結果(債権情報), JICC結果(ファイルM), JICC結果(注意Ｍ) Data Linkage", async () => {
    // Login as Admin
...
async function JIB_Record_Creation() {
  ...
  // 4 new JIB records will be created
  for (var i = 0; i < test_data.testData.four_no_of_records; i++) {
    // Go to JICC照会明細 (JID) record detail screen
    await parent.Open_Salesforce_JID_Record();
