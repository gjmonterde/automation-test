...
const parent = require("../Parent/Fj_TestScheme_30_0010-8");

export default function suite() {
  it("Fj_TestScheme_30_0010_step_08: 徴求書類 Requested document status is 「未提出」'Not Submitted'.", async () => {
