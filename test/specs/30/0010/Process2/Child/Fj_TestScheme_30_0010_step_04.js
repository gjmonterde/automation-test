...
const parent = require("../Parent/Fj_TestScheme_30_0010-2");
const util = require("../../../../../pageobjects/utility.js");

export default function suite() {
  it("Fj_TestScheme_30_0010_step_04: ご提出の状況 field value should be 銀行提出済 when reuploading files considered to be defective in My Page", async () => {
