...
const parent = require("../Parent/Fj_TestScheme_30_0010-3");
const util = require("../../../../../pageobjects/utility.js");

export default function suite() {
  it("Fj_TestScheme_30_0010_step_16: Should be able to select value from 不備理由 field for 徴求書類 record", async () => {
    ...
    const defect_reason_val2 = await $(
