...
import Fj_TestScheme_30_0010_step_16 from "../Child/Fj_TestScheme_30_0010_step_16.js";

export default async function suite() {
  describe("Fj_TestScheme_30_0010-3: Upload content check (アップロード内容確認)", () => {
    // Login as tantou1 user
    Login_As_Tantou1_User();

    // Execute Fj_TestScheme_30_0010_step_16
    Fj_TestScheme_30_0010_step_16();
  });
}
...
export async function Go_to_RDC1() {
  // Go to RDC 1
  await util.Open_SF_Record_URL(
    1,
