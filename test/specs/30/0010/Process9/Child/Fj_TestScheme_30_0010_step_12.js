...
const parent = require("../Parent/Fj_TestScheme_30_0010-9");
const util = require("../../../../../pageobjects/utility.js");

export default function suite() {
  it("Fj_TestScheme_30_0010_step_12: 徴求書類 Requested document form(3) status is「銀行提出済」Bank Submitted", async () => {
    ...
    const parent_row = await $(
      "//tr[@data-row-key-value='" + test_data.testData.rdc3_id_of_ver2 + "']"
    );
