...
const parent = require("../Parent/Fj_TestScheme_62_0002-10");
const util = require("../../../../../pageobjects/utility.js");

export default async function suite() {
  it("Fj_TestScheme_62_0002_step_25: The 確認 confirmation status changes to「実施済OK」 Performed OK", async () => {
    ...
    await ver_approve_btn.waitForClickable({ timeout: 10000 });
