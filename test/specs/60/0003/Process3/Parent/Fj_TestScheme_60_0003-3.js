...
import Fj_TestScheme_60_0003_step_07 from "../Child/Fj_TestScheme_60_0003_step_07";

export default async function suite() {
  describe("Fj_TestScheme_60_0003-3: Transaction inquiry result check (取引照会有無結果確認)", () => {
    // Login to Salesforce
    Login_To_Salesforce();

    // Execute Fj_TestScheme_60_0003_step_07
    Fj_TestScheme_60_0003_step_07();
  });
}
