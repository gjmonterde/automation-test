...
const parent = require("../Parent/Fj_TestScheme_60_0002-8");
const util = require("../../../../../pageobjects/utility");

export default function suite() {
  it("Fj_TestScheme_60_0002_step_22: Value for 徴求書類ステータス field should be 銀行確認済 upon clicking 確認 button", async () => {
