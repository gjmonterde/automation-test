...
const parent = require("../Parent/Fj_TestScheme_60_0010-11");
const util = require("../../../../../pageobjects/utility");

export default function suite() {
  it("Fj_TestScheme_60_0010_step_25: the 徴求書類 requested document status should be「銀行確認済」Bank Confirmed.", async () => {
