...
export default function suite() {
  it("Fj_TestScheme_10_0012_step_42: The 処理 processing status of the application is「完了」Completed・An メール通知 email notification and お知らせ(お借入中) notice (Financing Complete) should be generated on the application", async () => {
