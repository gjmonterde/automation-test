...
export default function suite() {
  it("Fj_TestScheme_60_0012_step_41: Successful save for borrowing status", async () => {
    ...
    // Go to App Record
    await parent.Open_SF_App_Record_URL();
    ...
    // Click pencil icon
    await $(".//span[@title='" + test_data.testData.cust_att_data + "']").$(
      function () {
        this.scrollIntoView();
      }
    );
