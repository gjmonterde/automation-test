...
export default async function suite() {
  it('Fj_TestScheme_60_0004_step_15_data: 顧客AMLチェック連携 Customer AML check collaboration for 銀行審査 Bank examination should be「連携済み」"Collaborated". (Data Linkage)', async () => {
