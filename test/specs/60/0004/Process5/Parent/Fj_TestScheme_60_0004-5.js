...
import Fj_TestScheme_60_0004_step_35 from "../Child/Fj_TestScheme_60_0004_step_35";

export default async function suite() {
  describe("Fj_TestScheme_60_0004-5: Department check result registration (所管部確認結果登録)", () => {
    // Login to Salesforce
    Login_To_Salesforce();

    // Execute Fj_TestScheme_60_0004_step_35
    Fj_TestScheme_60_0004_step_35();
  });
}
