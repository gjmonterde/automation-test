...
export default function suite() {
  it("Fj_TestScheme_60_0011_step_92: When the「既読にする」“Mark as Read ” button is pressed, it is updated to the read state.", async () => {
    const stepNum = "92"; // ★ 新環境適用' New Env Implementation
