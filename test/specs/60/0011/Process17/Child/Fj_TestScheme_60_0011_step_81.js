...
export default function suite() {
  it("Fj_TestScheme_60_0011_step_81: An email with the contents set in the メール通知(再条件確認) email notification (recondition confirmation) is sent.", async () => {
    const stepNum = "81"; // ★ 新環境適用' New Env Implementation
