...
const parent = require("../Parent/Fj_TestScheme_60_0011-20");

export default function suite() {
  it("Fj_TestScheme_60_0011_step_104: When the「既読にする」“Mark as Read ” button is pressed, it is updated to the read state", async () => {
