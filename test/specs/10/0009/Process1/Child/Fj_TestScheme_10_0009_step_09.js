...
export default async function suite() {
  it("Fj_TestScheme_10_0009_step_09: The value obtained from the 商品コードマスタ product code master is set in the 商品コード product code", async () => {
    const stepNum = "9"; // ★ 新環境適用' New Env Implementation

    // Go to ProductCode record
