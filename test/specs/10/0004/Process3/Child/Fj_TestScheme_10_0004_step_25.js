...
export default function suite() {
  it("Fj_TestScheme_10_0004_step_25: On the Bank Examination (3) detail screen: Check the items in the Audit Information Output Results Information section", async () => {
