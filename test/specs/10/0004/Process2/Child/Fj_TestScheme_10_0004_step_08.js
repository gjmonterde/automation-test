...
export default function suite() {
  it("Fj_TestScheme_10_0004_step_08: The 集計値 aggregate value of the 照会結果 inquiry result (the aggregation method is described in parentheses) is set as follows: クレジットカード有無 = (TRUE if any are TRUE)", async () => {
