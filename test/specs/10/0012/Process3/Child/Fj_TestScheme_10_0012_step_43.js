...
export default async function suite() {
  it("Fj_TestScheme_10_0012_step_43: The 申込 application status displayed on My Page must be「完了」 Completed", async () => {
    ...
    const appname_col = await $(
      ".//a[contains(., '" + test_data.testData.sort_app_mypage + "')]"
    );
