...
const parent = require("../Parent/Fj_TestScheme_10_0010-11");
const util = require("../../../../../pageobjects/utility");

export default function suite() {
  it("Fj_TestScheme_10_0010_step_25: Value for 徴求書類ステータス field should be 銀行確認済 upon clicking 確認 button", async () => {
