...
export default async function suite() {
  it("Fj_TestScheme_10_0011_step_96: The following item values must be updatable: 第一電話番号_登録", async () => {
    const stepNum = "96"; // ★ 新環境適用' New Env Implementation
    ...
    // Click Save
    // ★ 新環境適用' New Env Implementation
    await $(".//button[@name='" + test_data.testData.save_btn + "']").$(
      function () {
        this.scrollIntoView({
          block: "center",
        });
