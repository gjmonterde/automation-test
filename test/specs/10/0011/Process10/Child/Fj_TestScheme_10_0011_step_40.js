...
const parent = require("../Parent/Fj_TestScheme_10_0011-10");
const util = require("../../../../../pageobjects/utility.js");

export default async function suite() {
  it("Fj_TestScheme_10_0011_step_40: The email set in メール通知(契約同意) email notification (agreement) is sent", async () => {
