...
import Fj_TestScheme_10_0011_step_94 from "../Child/Fj_TestScheme_10_0011_step_94.js";
import Fj_TestScheme_10_0011_step_95 from "../Child/Fj_TestScheme_10_0011_step_95.js";

// ★ 新環境適用' New Env Implementation
export default async function suite() {
  describe("Fj_TestScheme_10_0011-20: My page contract agreement completion (マイページ契約同意完了)", () => {
    // Execute Fetch data
    Fetch_data();

    // Execute Fj_TestScheme_10_0011_step_94
    Fj_TestScheme_10_0011_step_94();

    // Execute Go_to_MyPage
    // Note: Can be skipped if executing Fj_TestScheme_10_0011_step_94 only
    Login_to_MyPage();

    // Execute Fj_TestScheme_10_0011_step_95
    Fj_TestScheme_10_0011_step_95();
  });
}
    ...
    await conn
      ...
      .execute(function (err, records) {
        ...
        for (var i = 0; i < records.length; i++) {
          var record = records[i];
          if (
            test_data.testData.awaiting_text ===
