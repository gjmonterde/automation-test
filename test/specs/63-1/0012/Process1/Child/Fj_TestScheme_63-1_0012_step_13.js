...
export default function suite() {
  it("Fj_TestScheme_63-1_0012_step_13: 実行依頼データ Submit data for the record type「14_カードローン回収」has been created", async () => {
    ...
    await parent.Get_ER_Array_Record(test_data.testData.er2_record_type);
    ...
    // Get LCD records
    await parent.Get_LCD_Record(test_data.testData.refund_flag_api, "48");
