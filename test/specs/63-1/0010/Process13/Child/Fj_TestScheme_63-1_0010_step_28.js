...
export default function suite() {
  it("Fj_TestScheme_63-1_0010_step_28: The amount of the loan (maximum adjustment) can be renewed to a value smaller than the amount of the loan", async () => {
    ...
    await loan_amount_upper_limit.scrollIntoView();
    ...
    await $(
      "//input[@id=//label[normalize-space(.)='" +
        ...
        "']/@for]"
    ).setValue(test_data.testData.loan_upper_limit_value);
    await browser.pause(3000);
