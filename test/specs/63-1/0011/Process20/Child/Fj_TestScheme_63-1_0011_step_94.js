...
export default function suite() {
  it("Fj_TestScheme_63-1_0011_step_94: An email with the content set in the メール通知(契約同意承認待ち) email notification (waiting for agreement approval) is sent", async () => {
