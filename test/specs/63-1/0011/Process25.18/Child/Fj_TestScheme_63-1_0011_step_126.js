...
export default function suite() {
  it("Fj_TestScheme_63-1_0011_step_126: The お申込み application status of My Page is「ご融資準備中」", async () => {
    const stepNum = "126"; // ★ 新環境適用' New Env Implementation
    ...
    // Click 契約に同意する button
    const btn1 = await $(
      ".//input[@value='" + test_data.testData.accept_contract_btn + "']"
    );
    await btn1.click();
