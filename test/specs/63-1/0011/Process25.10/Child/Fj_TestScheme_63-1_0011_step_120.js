...
export default function suite() {
  it("Fj_TestScheme_63-1_0011_step_120: The email set in the メール通知(契約同意) email notification (agreement) is sent", async () => {
    const stepNum = "120"; // ★ 新環境適用' New Env Implementation
