...
export default async function suite() {
  it("Fj_TestScheme_63-1_0011_step_115: The confirmation screen is displayed and the input value is reflected", async () => {
    const stepNum = "115"; // ★ 新環境適用' New Env Implementation
