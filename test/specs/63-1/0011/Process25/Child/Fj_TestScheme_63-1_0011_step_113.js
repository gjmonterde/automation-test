...
export default async function suite() {
  it("Fj_TestScheme_63-1_0011_step_113: Check the items must display the value that was determined at the time of the previous condition check", async () => {
    const stepNum = "113"; // ★ 新環境適用' New Env Implementation
