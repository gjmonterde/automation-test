...
export default function suite() {
  it("Fj_TestScheme_63-1_0011_step_129: An email with the content set in the メール通知(契約同意承認待ち) email notification (waiting for agreement approval) is sent", async () => {
    const stepNum = "129"; // ★ 新環境適用' New Env Implementation
