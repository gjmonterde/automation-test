...
const parent = require("../Parent/Fj_TestScheme_63-1_0011-25.20");
const util = require("../../../../../pageobjects/utility");

export default function suite() {
  it("Fj_TestScheme_63-1_0011_step_130: When the「既読にする」“Mark as Read ” button is pressed, it is updated to the read state", async () => {
    const stepNum = "130"; // ★ 新環境適用' New Env Implementation
