...
const parent = require("../Parent/Fj_TestScheme_40_0002-8");
const util = require("../../../../../pageobjects/utility");

export default async function suite() {
  it("Fj_TestScheme_40_0002_step_24: The verification status is changed to「書類確認完了」Document Verification Complete", async () => {
