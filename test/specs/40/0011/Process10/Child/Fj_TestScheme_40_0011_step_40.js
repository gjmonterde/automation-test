...
const parent = require("../Parent/Fj_TestScheme_40_0011-10");
const util = require("../../../../../pageobjects/utility");

export default function suite() {
  it("Fj_TestScheme_40_0011_step_40: The email set in メール通知(契約同意) email notification (agreement) is sent", async () => {
