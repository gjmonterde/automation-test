...
export default function suite() {
  it(
    "Fj_TestScheme_40_0011_step_11: The sub screen opens and you can enter and " +
      "save 振込先情報 transfer destination information",
    async () => {
      ...
      let ssno = 0;
      let save_ssno = test_data.testData.ba_new_record_no_value;
      for (var i = 0; i < test_data.testData.ba_new_record_no_value; i++) {
        // Click New BA button
        const new_btn = await $(
          "button=" + test_data.testData.mypage_ba_new_btn
        );
        ...
        const next_btn = await $(
          "button=" + test_data.testData.mypage_next_btn
        );
