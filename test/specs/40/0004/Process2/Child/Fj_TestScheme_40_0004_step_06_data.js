...
const parent = require("../Parent/Fj_TestScheme_40_0004-2");
const util = require("../../../../../pageobjects/utility");

export default async function suite() {
  it("Fj_TestScheme_40_0004_step_06_data: Manual update of クレジットカード情報連携 field to「連携済み」linked (data linkage)", async () => {
    ...
    await label.waitForClickable({ timeout: 10000 });
    await label.click();
    await browser.pause(3000);
