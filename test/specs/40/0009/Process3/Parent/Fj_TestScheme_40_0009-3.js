...
import Fj_TestScheme_40_0009_step_13 from "../Child/Fj_TestScheme_40_0009_step_13";

export default async function suite() {
  describe("Fj_TestScheme_40_0009-3: Result Notification Confirmation (結果通知確定)", () => {
    // Login to Salesforce
    // NOTE: ALWAYS execute before steps
    Login_to_Salesforce();

    // Execute Fj_TestScheme_40_0009_step_13
    Fj_TestScheme_40_0009_step_13();
  });
}
