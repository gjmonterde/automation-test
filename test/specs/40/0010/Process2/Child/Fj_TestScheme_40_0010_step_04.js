...
const parent = require("../Parent/Fj_TestScheme_40_0010-2");
const util = require("../../../../../pageobjects/utility");

export default function suite() {
  it(
    "Fj_TestScheme_40_0010_step_04: When you return to the 申込画面 application screen, " +
      "the 徴求書類 requested document status will be「銀行提出済」Bank Submitted",
    async () => {
