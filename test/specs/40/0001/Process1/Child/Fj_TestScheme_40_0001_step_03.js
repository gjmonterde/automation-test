...
export default async function suite() {
  it("Fj_TestScheme_40_0001_step_03: An error message is displayed and the completion screen is not displayed", async () => {
    const stepNum = "3"; // ★ 新環境適用' New Env Implementation

    if (test_data.testData.auth_agree !== test_data.testData.isTrue) {
