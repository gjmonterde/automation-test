...
import Fj_TestScheme_40_0006_step_28 from "../Child/Fj_TestScheme_40_0006_step_28";

export default async function suite() {
  describe("Fj_TestScheme_40_0006-6: Scoring Result checked (スコアリング結果確定)", () => {
    // Login to Salesforce
    // NOTE: ALWAYS execute before steps
    Login_to_Salesforce();

    // Execute Fj_TestScheme_40_0006_step_28
    Fj_TestScheme_40_0006_step_28();
  });
}
