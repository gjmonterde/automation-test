...
export default async function suite() {
  it(
    "Fj_TestScheme_40_0006_step_11: In the 合計 Total Sections of the 借入明細情報一覧 " +
      "Loan details Information list , each section's aggregate values for  今回 current, " +
      "申告 Notice, 当行 our bank, JICC, KSC, and 追加 are displayed. 借入総額 = Sum of 残債額 Residual Bond Amount Column",
    async () => {
