...
import Fj_TestScheme_40_0007_step_01 from "../Child/Fj_TestScheme_40_0007_step_01";
import Fj_TestScheme_40_0007_step_02 from "../Child/Fj_TestScheme_40_0007_step_02";
import Fj_TestScheme_40_0007_step_03 from "../Child/Fj_TestScheme_40_0007_step_03";
import Fj_TestScheme_40_0007_step_04 from "../Child/Fj_TestScheme_40_0007_step_04";
import Fj_TestScheme_40_0007_step_05 from "../Child/Fj_TestScheme_40_0007_step_05";

export default async function suite() {
  describe("Fj_TestScheme_40_0007-1: Initial process check (初期処理確認)", () => {
    // Fetch data
    // NOTE: ALWAYS execute before steps
    Fetch_data();

    // Login to Salesforce as user in charge
    // NOTE: Execute before steps (except step 2)
    Login_as_tantou();

    // Execute Fj_TestScheme_40_0007_step_01
    Fj_TestScheme_40_0007_step_01();

    // Execute Fj_TestScheme_40_0007_step_02
    Fj_TestScheme_40_0007_step_02();

    // Login to Salesforce as user in charge
    // NOTE: Re-execute if running steps after step 2
    Login_as_tantou();

    // Execute Fj_TestScheme_40_0007_step_03
    Fj_TestScheme_40_0007_step_03();

    // Execute Fj_TestScheme_40_0007_step_04
    Fj_TestScheme_40_0007_step_04();

    // Execute Fj_TestScheme_40_0007_step_05
    Fj_TestScheme_40_0007_step_05();
  });
}
...
async function Fetch_data() {
  it("Fetch data from Salesforce", async () => {
    ...
    await conn
      ...
      .select("Id, Name, fj_ProductCode__c, RecordType.Name")
      .where({
