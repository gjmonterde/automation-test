...
import Fj_TestScheme_20_0004_step_31 from "../Child/Fj_TestScheme_20_0004_step_31";

export default async function suite() {
  describe("Fj_TestScheme_20_0004-5: Department check result regstration (所管部確認結果登録)", () => {
    // Login to Salesforce
    Login_To_Salesforce();

    // Execute Fj_TestScheme_20_0004_step_31
    Fj_TestScheme_20_0004_step_31();
  });
}
