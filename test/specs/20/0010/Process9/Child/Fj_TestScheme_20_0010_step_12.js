...
export default function suite() {
  it("Fj_TestScheme_20_0010_step_12: ご提出の状況 field value should be 銀行提出済 when reuploading files considered to be defective in My Page", async () => {
    ...
    const parent_row = await $(
      "//tr[@data-row-key-value='" + test_data.testData.rdc3_id + "']"
    );
