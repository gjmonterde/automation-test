...
export default function suite() {
  it("Fj_TestScheme_20_0010_step_37: 顧客番号再取得連携ステータス field value should be edited to 手動照会済み while any values can be set to both 全店顧客番号 and 融資基本口座番号 fields", async () => {
