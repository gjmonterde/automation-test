...
const parent = require("../Parent/Fj_TestScheme_20_0011-10");

export default function suite() {
  it("Fj_TestScheme_20_0011_step_41: At My Page Home, click the link for お知らせ(契約同意)notification (agreement)", async () => {
    ...
    // Screenshot - My Page お知らせ screen (top)
    ...
    // Find Notification (agreement) record in list
    ...
    // Screenshot - My Page お知らせ screen (record)
