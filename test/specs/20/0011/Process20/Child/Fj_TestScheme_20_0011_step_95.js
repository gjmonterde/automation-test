...
const parent = require("../Parent/Fj_TestScheme_20_0011-20");

export default function suite() {
  it("Fj_TestScheme_20_0011_step_95: At My Page Home, click the  link notification link お知らせ(契約同意承認待ち)(waiting for agreement approval)", async () => {
