...
const parent = require("../Parent/Fj_TestScheme_20_0011-23");

export default function suite() {
  it("Fj_TestScheme_20_0011_step_103: At My Page Home, click the link for お知らせ(契約成立) notification (contract)", async () => {
    ...
    // Find Notification (contract) record in list
