...
export default function suite() {
  it("Fj_TestScheme_20_0011_step_102: The email set in メール通知(契約成立) email notification (contract formation) is sent", async () => {
    ...
    // The mail set in メール通知(条件確認) mail notification (contract formation) is sent
    // Screenshot - E-mail
