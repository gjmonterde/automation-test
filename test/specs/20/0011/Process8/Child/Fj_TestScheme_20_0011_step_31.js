...
export default function suite() {
  it("Fj_TestScheme_20_0011_step_31: The 確認画面 confirmation screen is displayed and the input value is reflected", async () => {
    ...
    await btn1.waitForClickable({ timeout: 5000 });
    await btn1.click();
    ...
    // Screenshot お借入れ内容調整（内容確認）- loading
    await browser.switchToParentFrame();
    await browser.saveFullPageScreen(
      user_info.userInformation.screenshot +
        test_data.testData.spec20 +
