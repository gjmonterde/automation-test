...
export default async function suite() {
  it(
    "Fj_TestScheme_70_0009_step_14: The e-mail with the content set in メール通知(審査結果(応諾))" +
      "the e-mail notification (examination result (compliance)) is sent",
    async () => {
      ...
      // Click Print
      await util.View_full_email("75%"); // ★ 新環境適用' New Env Implementation
