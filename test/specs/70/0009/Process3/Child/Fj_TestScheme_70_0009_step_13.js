...
const parent = require("../Parent/Fj_TestScheme_70_0009-3");
const util = require("../../../../../pageobjects/utility.js"); // ★ 新環境適用' New Env Implementation

export default async function suite() {
  it("Fj_TestScheme_70_0009_step_13: 結果通知 Result notification status changes to 「承認済OK」Approved OK", async () => {
