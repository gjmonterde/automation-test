...
const parent = require("../Parent/Fj_TestScheme_70_0010-6"); // ★ 新環境適用' New Env Implementation

export default async function suite() {
  it(
    "Fj_TestScheme_70_0010_step_14: When you return to the application screen, the 徴求書類request document " +
      "status will be 「銀行提出済」Bank Submitted",
    async () => {
      ...
      await det_btn.waitForClickable({ timeout: 30000 });
      await det_btn.click();
      ...
      const parent_row = await $(
        "//tr[@data-row-key-value='" + test_data.testData.rdc_id + "']"
      );
