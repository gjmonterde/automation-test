...
export default async function suite() {
  it("Fj_TestScheme_70_0006_step_16_data: Manual process for 審査決裁 record update (data linkage)", async () => {
    ...
    await exam_approval_collab_status_lbl.$(function () {
      this.scrollIntoView({
        behavior: "smooth",
        block: "center",
        inline: "center",
    ...
    await exam_approval_collab_status_lbl.waitForClickable({ timeout: 30000 });
    ...
    const examval = await $(
      "//span[@title='" +
        test_data.testData.exs_exam_cooperation_status_val +
        "']"
    );
    await examval.waitForClickable({ timeout: 5000 });
    await examval.click();
    await browser.pause(2000);
