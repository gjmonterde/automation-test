...
const parent = require("../Parent/Fj_TestScheme_70_0011-19"); // ★ 新環境適用' New Env Implementation

export default async function suite() {
  it("Fj_TestScheme_70_0011_step_104: 申込.処理 status is changed to 「契約同意待ち」 Pending Agreement", async () => {
