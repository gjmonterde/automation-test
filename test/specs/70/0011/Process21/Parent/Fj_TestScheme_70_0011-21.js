...
import Fj_TestScheme_70_0011_step_112 from "../Child/Fj_TestScheme_70_0011_step_112.js";

export default async function suite() {
  describe("Fj_TestScheme_70_0011-21: Final Approval (最終承認)", () => {
    // Execute login to salesforce
    // NOTE: ALWAYS execute before steps
    Login_to_Salesforce();

    // Execute Fj_TestScheme_70_0011_step_112
    Fj_TestScheme_70_0011_step_112();
  });
}
...
async function Login_to_Salesforce() {
  it("Login to Salesforce", async () => {
    ...
    if (test_data.testData.logged_status != "auditor") {
      ...
      test_data.testData.logged_status = "auditor"; // ★ 新環境適用' New Env Implementation
    ...
    // Go to App record
    await Open_APP_Record(); // ★ 新環境適用' New Env Implementation
  });
}
