...
const parent = require("../Parent/Fj_TestScheme_70_0011-17.09"); // ★ 新環境適用' New Env Implementation

export default async function suite() {
  it("Fj_TestScheme_70_0011_step_89: The 申込.処理 processing status is changed to 「契約同意待ち」 Pending Agreement", async () => {
