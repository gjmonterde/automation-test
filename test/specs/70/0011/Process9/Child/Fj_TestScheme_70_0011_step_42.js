...
export default async function suite() {
  it(
    "Fj_TestScheme_70_0011_step_42: Validation Error 「お借入内容調整実施済みのため、融資条件項目は変更できません。」" +
    ...
    async () => {
      ...
      await action.waitForClickable({ timeout: 30000 });
      await action.click();
      ...
      await $(".//input[@id='" + branchnameid + "']").setValue(
        test_data.testData.ba_branch_name_val2
      );
