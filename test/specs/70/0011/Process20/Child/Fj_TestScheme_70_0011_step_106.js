...
const parent = require("../Parent/Fj_TestScheme_70_0011-20");

export default async function suite() {
  it("Fj_TestScheme_70_0011_step_106: When the “「既読にする」 Mark as Read ” button is pressed, it is updated to the read state", async () => {
