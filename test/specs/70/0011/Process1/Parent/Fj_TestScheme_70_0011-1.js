...
import Fj_TestScheme_70_0011_step_01 from "../Child/Fj_TestScheme_70_0011_step_01.js";

export default async function suite() {
  describe("Fj_TestScheme_70_0011-1: Initial process check (初期処理確認)", () => {
    // Execute login to Salesforce
    // NOTE: ALWAYS execute before steps
    Login_to_Salesforce();

    // Execute Fj_TestScheme_70_0011_step_01
    Fj_TestScheme_70_0011_step_01();
  });
}
    ...
    await conn
      ...
      .execute(function (err, records) {
        ...
        for (var i = 0; i < records.length; i++) {
          ...
          if (
            record.fj_WebNotificationType__c ===
            test_data.testData.bankacct_rectype
          ) {
