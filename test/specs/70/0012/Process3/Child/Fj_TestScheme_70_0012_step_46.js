...
export default async function suite() {
  it(
    "Fj_TestScheme_70_0012_step_46: When the「既読にする」 “Mark as Read ” button is pressed, " +
      "it is updated to the read state",
    async () => {
      ...
      await $(
        ".//a[@aria-label='" +
          test_data.testData.mypage_viewall_notif_link +
          "']"
      ).click();
      await browser.pause(10000);
