...
export default async function suite() {
  it(
    "Fj_TestScheme_70_0012_step_15: The number of 実行依頼データ submission data of the record type " +
      "「19_カードローン実行」 19 _ Card Loan Execution corresponding to the number of 貸出共通明細" +
      "（既貸回収フラグflag ＝TRUE　and　科目コード＝48） detail for common lending (Open Loan Collection Flag = " +
      "TRUE and account code = 48) has been created",
    async () => {
